...
@implementation GW_AnimatedGIFImageSerialization

+ (UIImage *)GW_ImageWithData:(NSData *)data
                     error:(NSError * __autoreleasing *)error
{
    return [self GW_ImageWithData:data scale:1.0f duration:0.0f error:error];
}
...
+ (NSData *)GW_AnimatedGIFDataWithImage:(UIImage *)image
                               error:(NSError * __autoreleasing *)error
{
    return [self GW_AnimatedGIFDataWithImage:image duration:0.0f loopCount:0 error:error];
}
...
+ (void)load {
    ...
    dispatch_once(&onceToken, ^{
        @autoreleasepool {
            animated_gif_swizzleSelector(object_getClass((id)self), @selector(imageNamed:), @selector(GW_Animated_gif_imageNamed:));
            animated_gif_swizzleSelector(object_getClass((id)self), @selector(imageWithData:), @selector(GW_Animated_gif_imageWithData:));
            animated_gif_swizzleSelector(object_getClass((id)self), @selector(imageWithData:scale:), @selector(GW_Animated_gif_imageWithData:scale:));
            animated_gif_swizzleSelector(object_getClass((id)self), @selector(imageWithContentsOfFile:), @selector(GW_Animated_gif_imageWithContentsOfFile:));
            animated_gif_swizzleSelector(self, @selector(initWithContentsOfFile:), @selector(GW_Animated_gif_initWithContentsOfFile:));
            animated_gif_swizzleSelector(self, @selector(initWithData:), @selector(GW_Animated_gif_initWithData:));
            animated_gif_swizzleSelector(self, @selector(initWithData:scale:), @selector(GW_Animated_gif_initWithData:scale:));
        }
    });
}
...
+ (UIImage *)GW_Animated_gif_imageNamed:(NSString *)name __attribute__((objc_method_family(new))) {
    ...
    return [self GW_Animated_gif_imageNamed:name];
}

+ (UIImage *)GW_Animated_gif_imageWithContentsOfFile:(NSString *)path __attribute__((objc_method_family(new))) {
    if (path) {
        NSData *data = [NSData dataWithContentsOfFile:path];
        if (AnimatedGifDataIsValid(data)) {
    ...
    return [self GW_Animated_gif_imageWithContentsOfFile:path];
}

+ (UIImage *)GW_Animated_gif_imageWithData:(NSData *)data __attribute__((objc_method_family(init))) {
    if (AnimatedGifDataIsValid(data)) {
        return UIImageWithAnimatedGIFData(data);
    }

    return [self GW_Animated_gif_imageWithData:data];
}

+ (UIImage *)GW_Animated_gif_imageWithData:(NSData *)data
                                  scale:(CGFloat)scale __attribute__((objc_method_family(init)))
{
    ...
    return [self GW_Animated_gif_imageWithData:data scale:scale];
}

#pragma mark -

- (id)GW_Animated_gif_initWithContentsOfFile:(NSString *)path __attribute__((objc_method_family(init))) {
    NSData *data = [NSData dataWithContentsOfFile:path];
    if (AnimatedGifDataIsValid(data)) {
        if ([[path stringByDeletingPathExtension] hasSuffix:@"@2x"]) {
    ...
    return [self GW_Animated_gif_initWithContentsOfFile:path];
}

- (id)GW_Animated_gif_initWithData:(NSData *)data __attribute__((objc_method_family(init))) {
    if (AnimatedGifDataIsValid(data)) {
        return UIImageWithAnimatedGIFData(data);
    }

    return [self GW_Animated_gif_initWithData:data];
}

- (id)GW_Animated_gif_initWithData:(NSData *)data
                          scale:(CGFloat)scale __attribute__((objc_method_family(init)))
{
    if (AnimatedGifDataIsValid(data)) {
        return UIImageWithAnimatedGIFData(data, scale, 0.0f, nil);
    ...
    return [self GW_Animated_gif_initWithData:data scale:scale];
}
